...
- **Primary Location**: `/mnt/c/Code/MCPServers/DebugHostMCP/project_docs/requirements/`
- **Secondary Location**: `/mnt/c/Code/MCPServers/DebugHostMCP/deliverables/requirements/`
- **Naming Convention**: `YYYY-MM-DD-prd-[version].md`
- **Supporting Files**: All related requirements documents in same directory

## 🚨 CRITICAL PATH VALIDATION
Before any file operation:
1. Verify path starts with `/mnt/c/Code/MCPServers/DebugHostMCP/project_docs/requirements/` or `/mnt/c/Code/MCPServers/DebugHostMCP/deliverables/requirements/`
...
- **Save final PRD to**: `/mnt/c/Code/MCPServers/DebugHostMCP/project_docs/requirements/[timestamp]-prd-document.md`
